...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<xyz.dapplink.iface.lib.HelloRequest,
      xyz.dapplink.iface.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = xyz.dapplink.iface.lib.HelloRequest.class,
      responseType = xyz.dapplink.iface.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<xyz.dapplink.iface.lib.HelloRequest,
      xyz.dapplink.iface.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<xyz.dapplink.iface.lib.HelloRequest, xyz.dapplink.iface.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<xyz.dapplink.iface.lib.HelloRequest, xyz.dapplink.iface.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  xyz.dapplink.iface.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  xyz.dapplink.iface.lib.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(xyz.dapplink.iface.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<xyz.dapplink.iface.lib.HelloReply> responseObserver) {
  ...
  public static final class SimpleStub
     ...
     * </pre>
     */
    public void sayHello(xyz.dapplink.iface.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<xyz.dapplink.iface.lib.HelloReply> responseObserver) {
  ...
  public static final class SimpleBlockingStub
     ...
     * </pre>
     */
    public xyz.dapplink.iface.lib.HelloReply sayHello(xyz.dapplink.iface.lib.HelloRequest request) {
  ...
  public static final class SimpleFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<xyz.dapplink.iface.lib.HelloReply> sayHello(
        xyz.dapplink.iface.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((xyz.dapplink.iface.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<xyz.dapplink.iface.lib.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              xyz.dapplink.iface.lib.HelloRequest,
              xyz.dapplink.iface.lib.HelloReply>(
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return xyz.dapplink.iface.lib.HelloWorldProto.getDescriptor();
    }
